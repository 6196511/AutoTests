...
import time
from creds import admin_login, admin_password, guide_per_head_split_login, guide_per_head_split_password
import random
...
guide_per_head_split_rate_first = 10
guide_per_head_split_rate_add = 5
AdultTickets = '5'
ChildTickets = '5'
...
class Test_GODO6_15(BaseTest):
    def test_6(self):
        ...
        page = loginpage()
        page.open()
        page.login_field.send_keys(guide_per_head_split_login)
        page.password_field.send_keys(guide_per_head_split_password)
        page.button.click()
        page = GuidePage()
        time.sleep(2)
        page.day_button.click()
