...
class BookingQuestionsPage(BasePage):
    ...
    custom_questions_add_question_set_plus_button = Find(by=By.XPATH, value="//div[@ng-click='vm.addQuestionSet()']")
    question_set_name = Find(by=By.XPATH, value="//input[@ng-model='vm.questionSet.name']")
    selected_activities_list = Find(by=By.XPATH, value="//select[@ng-model='ga.selectedItem']")
    selected_activities_lists = Finds(by=By.XPATH, value="//select[@ng-model='ga.selectedItem']")
    question1_custom_title = Find(by=By.XPATH, value="//*[@id='wrapper']/div[6]/div/div/div[2]/div/popup-content-loader/ng-transclude/div[2]/div/div/gd-question-set[1]/div/div/div[3]/div/div/gd-question/div/div/div[1]/div/h4")
    question2_custom_title = Find(by=By.XPATH, value="//*[@id='wrapper']/div[6]/div/div/div[2]/div/popup-content-loader/ng-transclude/div[2]/div/div/gd-question-set[1]/div/div/div[3]/div/div[2]/gd-question/div/div/div[1]/div/h4")
    question3_custom_title = Find(by=By.XPATH, value="//*[@id='wrapper']/div[6]/div/div/div[2]/div/popup-content-loader/ng-transclude/div[2]/div/div/gd-question-set[1]/div/div/div[3]/div/div[3]/gd-question/div/div/div[1]/div/h4")
    custom_questions_msg = Find(by=By.XPATH, value="//*[@id='wrapper']/div[6]/div/div/div[2]/div/popup-content-loader/ng-transclude/div[2]/div/div/div[1]")
    custom_questions_titles = Finds(by=By.XPATH, value="//span[@ng-bind='vm.questionSet.name']")
    custom_questions_question = Finds(by=By.XPATH, value="//span[@ng-bind='vm.question.text']")
    custom_questions_edit_buttons = Finds(by=By.XPATH, value="//div[@ng-click='vm.toggleEdit()']")
    edit_custom_questions_titles = Finds(by=By.XPATH, value="//h4")
