...
class Test_GODO888(BaseTest):
    def test_888(self):
        ...
        assert page.timeline_email_title.get_attribute('textContent') == 'Purchased Tickets for the '+''.join(ActivityName)
        ...
        assert row[9] == 'ESP' #customer_country
