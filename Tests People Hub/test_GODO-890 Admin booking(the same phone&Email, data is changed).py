...
class Test_GODO890(BaseTest):
    def test_890(self):
        ...
        page.address1_field.send_keys(Address1)
        ...
        assert page.state_info.get_attribute('innerText')=='AZ'
        #assert page.address_info.get_attribute('innerText') == Address1 #BUG 2827
        ...
        assert row[4] == Address1 #customer_address_1
        assert row[5] == None #customer_address_2
        assert row[6] == None #customer_city
        assert row[7] == 'AZ' #customer_state
        assert row[8] == None #customer_zipcode
        assert row[9] == 'USA' #customer_country
        ...
        NewFirstName = NewFirstName + '-Sergey'# STEP21
        page.first_name.send_keys(NewFirstName)
        NewLastName = NewLastName + '-Kameneff'
        page.last_name.send_keys(NewLastName)
        NewFullName = NewFirstName + ' ' + ''.join(NewLastName)
        page.phone_number.send_keys(NewPhone)
        page.email_address.send_keys(NewEmail)
