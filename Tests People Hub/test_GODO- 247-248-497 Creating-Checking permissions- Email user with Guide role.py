...
username_list = []
pwd_list = []
permission_1 = 'Edit Customers Information'
permission_2 = 'Edit Company Info Pages'
...
class Test_GODO247_248_497(BaseTest):
    def test_247(self):
        ...
        NewUserName = ("autotest247_" + ''.join(choice(digits) for i in range(4)))
