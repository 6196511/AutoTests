...
@pytest.mark.parametrize("addons", addons[0:1], ids=[repr(x) for x in addons[0:1]])
...
@pytest.mark.parametrize("addons", addons[1:2], ids=[repr(x) for x in addons[1:2]])
...
@pytest.mark.parametrize("addons", addons[2:3], ids=[repr(x) for x in addons[2:3]])
...
@pytest.mark.parametrize("admin", admin[0:1], ids=[repr(x) for x in admin[0:1]])
...
@pytest.mark.parametrize("admin", admin[1:2], ids=[repr(x) for x in admin[1:2]])
...
@pytest.mark.parametrize("addons", addons[3:4], ids=[repr(x) for x in addons[3:4]])
...
@pytest.mark.parametrize("admin", admin[3:4], ids=[repr(x) for x in admin[3:4]])
...
@pytest.mark.parametrize("addons", addons[4:5], ids=[repr(x) for x in addons[4:5]])
...
@pytest.mark.parametrize("addons", addons[5:6], ids=[repr(x) for x in addons[5:6]])
...
@pytest.mark.parametrize("admin", admin[2:3], ids=[repr(x) for x in admin[2:3]])
