...
@pytest.mark.parametrize("guides", guides[1:2], ids=[repr(x) for x in guides[1:2]])
...
@pytest.mark.parametrize("guides", guides[2:3], ids=[repr(x) for x in guides[2:3]])
...
@pytest.mark.parametrize("guides", guides[3:4], ids=[repr(x) for x in guides[3:4]])
...
@pytest.mark.parametrize("guides", guides[4:5], ids=[repr(x) for x in guides[4:5]])
...
@pytest.mark.parametrize("guides", guides[5:6], ids=[repr(x) for x in guides[5:6]])
...
@pytest.mark.parametrize("guides", guides[6:7], ids=[repr(x) for x in guides[6:7]])
...
@pytest.mark.parametrize("guides", guides[7:8], ids=[repr(x) for x in guides[7:8]])
...
@pytest.mark.parametrize("guides", guides[8:9], ids=[repr(x) for x in guides[8:9]])
