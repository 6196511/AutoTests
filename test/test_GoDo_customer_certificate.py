import pytest
from data.orders import customer_certificates, customer_certificates_declines


@pytest.mark.parametrize("certificate", customer_certificates, ids=[repr(x) for x in customer_certificates])
